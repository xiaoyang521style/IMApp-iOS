...
static const NSString *gIv = @"MIXIU.YIQIHI.COM";
...
- (NSData *)AES256_Encrypt:(NSString *)key
{
    ...
    [key getCString:keyPtr maxLength:sizeof(keyPtr) encoding:NSNonLossyASCIIStringEncoding];
...
//    [gIv getCString:ivPtr maxLength:sizeof(ivPtr) encoding:NSNonLossyASCIIStringEncoding];
