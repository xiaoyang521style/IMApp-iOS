...
+ (UIImage*)imageWithIcon:(NSString*)iconCode size:(NSUInteger)size color:(UIColor*)color {
    ...
    label.text = [NSString iconWith:iconCode];
    if(color){
...
+(UIImage *)imageWithPathOfName:(NSString *)imgName{
   NSString *path = [[[NSBundle mainBundle]resourcePath] stringByAppendingPathComponent:imgName];
