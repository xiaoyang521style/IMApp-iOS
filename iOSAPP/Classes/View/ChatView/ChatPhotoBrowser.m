...
@interface ChatPhotoBrowser () <UIActionSheetDelegate,ImageScrollViewDelegate>
@end

@implementation ChatPhotoBrowser
...
+(void)showOriginalImage:(UIImage *)originalImage{
    ChatPhotoBrowser *browser = [[ChatPhotoBrowser alloc] initWithFrame:kKeyWindow.bounds];
