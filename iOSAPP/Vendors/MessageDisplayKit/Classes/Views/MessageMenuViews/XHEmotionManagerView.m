...
- (void)setup {
    ...
    if (!_emotionCollectionView) {
        UICollectionView *emotionCollectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, 0, CGRectGetWidth(self.bounds), CGRectGetHeight(self.bounds) - kXHEmotionPageControlHeight - kXHEmotionSectionBarHeight - TabbarSafeBottomMargin) collectionViewLayout:[[XHEmotionCollectionViewFlowLayout alloc] init]];
    ...
    if (!_emotionSectionBar) {
        XHEmotionSectionBar *emotionSectionBar = [[XHEmotionSectionBar alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(self.emotionPageControl.frame), CGRectGetWidth(self.bounds), kXHEmotionSectionBarHeight +TabbarSafeBottomMargin) showEmotionStoreButton:self.isShowEmotionStoreButton];
