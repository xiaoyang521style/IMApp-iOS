...
- (instancetype)initWithPhoto:(UIImage *)photo
              originPhotoPath:(NSString *)originPhotoPath
    ...
    if (self) {
        ...
        self.originPhotoPath = originPhotoPath;
        self.sender = sender;
        self.timestamp = timestamp;
...
- (id)copyWithZone:(NSZone *)zone {
    switch (self.messageMediaType) {
        ...
        case XHBubbleMessageMediaTypePhoto:
            return [[[self class] allocWithZone:zone] initWithPhoto:[self.photo copy]               originPhotoPath:[self.originPhotoPath copy]
