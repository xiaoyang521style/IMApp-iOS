...
@implementation ChatRecordVoiceHUD
...
+(void)updatePeakPower:(CGFloat)peakPower{
    ChatRecordVoiceHUD *hud = [kKeyWindow viewWithTag:999];
    if (!hud){
        hud = [[ChatRecordVoiceHUD alloc] initWithFrame:CGRectMake(0, 0, 150, 150)];
