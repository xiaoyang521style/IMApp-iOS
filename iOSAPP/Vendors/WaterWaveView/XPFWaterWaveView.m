...
@implementation XPFWaterWaveView {
...
- (void)drawRect:(CGRect)rect {
    ...
    [path addQuadCurveToPoint:CGPointMake(0, rect.size.height) controlPoint:CGPointMake(rect.size.width * 0.5, rect.size.height)];
...
- (void)setFirstWaveLayerPathWithOffsetX:(CGFloat)waveOffsetX {
    ...
    [bezierPath addQuadCurveToPoint:CGPointMake(0, self.bounds.size.height) controlPoint:CGPointMake(self.bounds.size.width * 0.5, self.bounds.size.height)];
